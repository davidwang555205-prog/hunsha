...
WALA_IMAGE_MODEL="${WALA_IMAGE_MODEL:-gpt-image-2-c}"
WALA_IMAGE_QUALITY="${WALA_IMAGE_QUALITY:-medium}"
DEFAULT_DAILY_IMAGE_LIMIT="${DEFAULT_DAILY_IMAGE_LIMIT:-20}"
...
DEFAULT_DAILY_IMAGE_LIMIT=$DEFAULT_DAILY_IMAGE_LIMIT
